...
public class CuentaManager {
    ...
    /**
     * Busca una lista de cuentas por el nombre completo
     * Esta armado para que se pueda generar un SQL Injection y mostrar commo NO debe programarse.
     * @param nombre
     * @return
     */
    public List<Cuenta> buscarPor(String nombre) {
        ...
        //como nombre: "' or '1'='1"
        Query query = session.createNativeQuery("SELECT * FROM cuenta where nombre = '"+nombre+"'", CurrentTenantIdentifierResolver.class);
